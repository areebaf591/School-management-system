...
<body>
    ...
    <main class="container mx-auto px-6 py-8">
        ...
        <div class="page-header glass-card rounded-xl p-8 mb-8">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="text-3xl font-bold text-gradient mb-2">User Management</h2>
                        <p class="text-zinc-600 text-lg">Manage user accounts, roles, and permissions</p>
                    </div>
                </div>
                <div class="flex space-x-4">
                    <div class="text-center">
                        <p class="text-3xl font-bold text-teal-600">{{ $approvedUsersCount }}</p>
                        <p class="text-sm text-zinc-500">Approved Users</p>
                    </div>
                    <div class="text-center">
                        <p class="text-3xl font-bold text-yellow-600">{{ $pendingUsersCount }}</p>
                        <p class="text-sm text-zinc-500">Pending Users</p>
                    </div>
                </div>
            </div>
        </div>
      ...
      onsubmit="event.stopPropagation(); return confirm('Reject this user?');">
    @csrf
    <button type="submit"
    ...
    <div class="flex items-center justify-between mb-4">
        <div class="flex items-center">
            ...
            <h3 class="text-xl font-semibold text-zinc-800">Approved Users</h3>
        </div>
